...
export const MyPokemonListScreen = () => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_API_URL + `/v2/pokemon/${detail.id}`).then(res => setMyPokemonData(res.data))
  }, [])
  return (
    <>
      <Card>
        <CardHeader sx={{ m: 'auto', backgroundColor: '#9ED5C5' }}
          title={"My Pokemon list"}></CardHeader>
